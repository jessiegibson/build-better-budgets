...
def process_tables(tables: List[pd.DataFrame], format_name: str, format_config: Dict[str, Any]) -> pd.DataFrame:
    """
    ...
    if format_name == 'chase':
        ...
        return process_receipt_tables(tables, format_config)
    else:
        # Generic processing
...
def process_receipt_tables(tables: List[pd.DataFrame], format_config: Dict[str, Any]) -> pd.DataFrame:
